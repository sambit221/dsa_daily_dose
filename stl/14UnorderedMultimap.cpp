// WAP to show operations using unordered_multimap (associative container)

// it is same as multimap but only diff is it will be under diff preprocessor, will not be sorted, subscript operators are not allowed here
#include<iostream>
...
int main(int argc, char const *argv[]){
    ...
    // As subscript operator is not allowed in multimap, unordered_multimap
    //mp[4] = 400;
    //mp[3] = 300;
